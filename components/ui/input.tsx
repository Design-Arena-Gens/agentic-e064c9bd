  ...
  return (
    <label className="flex flex-col gap-1 text-sm text-slate-200" htmlFor={inputId}>
      ...
      <input
        ...
        id={inputId}
        className={clsx(
          "rounded-xl border border-slate-700 bg-slate-900/60 px-3 py-2 text-base text-slate-100 placeholder-slate-500 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/40",
          className
        )}
        {...rest}
      />
